...
public class ICustomerConnectorServiceLookUpByForeignSystemIdMalformedRequestFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public ICustomerConnectorServiceLookUpByForeignSystemIdMalformedRequestFaultFaultFaultMessage(String message, MalformedRequestFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ICustomerConnectorServiceLookUpByForeignSystemIdMalformedRequestFaultFaultFaultMessage(String message, MalformedRequestFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
