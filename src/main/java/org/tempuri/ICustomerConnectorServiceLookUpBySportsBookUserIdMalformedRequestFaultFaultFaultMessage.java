...
public class ICustomerConnectorServiceLookUpBySportsBookUserIdMalformedRequestFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public ICustomerConnectorServiceLookUpBySportsBookUserIdMalformedRequestFaultFaultFaultMessage(String message, MalformedRequestFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ICustomerConnectorServiceLookUpBySportsBookUserIdMalformedRequestFaultFaultFaultMessage(String message, MalformedRequestFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
