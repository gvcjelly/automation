...
public class ICustomerConnectorServiceGetAssociatedAccountsMalformedRequestFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public ICustomerConnectorServiceGetAssociatedAccountsMalformedRequestFaultFaultFaultMessage(String message, MalformedRequestFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ICustomerConnectorServiceGetAssociatedAccountsMalformedRequestFaultFaultFaultMessage(String message, MalformedRequestFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
