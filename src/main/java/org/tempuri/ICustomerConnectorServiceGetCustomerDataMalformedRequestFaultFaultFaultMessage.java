...
public class ICustomerConnectorServiceGetCustomerDataMalformedRequestFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public ICustomerConnectorServiceGetCustomerDataMalformedRequestFaultFaultFaultMessage(String message, MalformedRequestFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ICustomerConnectorServiceGetCustomerDataMalformedRequestFaultFaultFaultMessage(String message, MalformedRequestFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
