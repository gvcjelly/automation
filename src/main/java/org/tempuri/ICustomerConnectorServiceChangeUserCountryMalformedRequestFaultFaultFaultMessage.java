...
public class ICustomerConnectorServiceChangeUserCountryMalformedRequestFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public ICustomerConnectorServiceChangeUserCountryMalformedRequestFaultFaultFaultMessage(String message, MalformedRequestFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ICustomerConnectorServiceChangeUserCountryMalformedRequestFaultFaultFaultMessage(String message, MalformedRequestFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
